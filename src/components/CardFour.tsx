...
const CardFour = () => {
  ...
  let dataUsers = data.total_users;
  try {
    let dataAmount = dataUsers.amount;
    let dataPercent = dataUsers.change_percent;
    ...
    <div className="rounded-sm border border-stroke bg-white py-6 px-7.5 shadow-default dark:border-strokedark dark:bg-boxdark">
        ...
        <div className="mt-4 flex items-end justify-between">
          <div>
            {
            dataUsers && ( //Check if recieved data from API endpoint
              <>
                {
